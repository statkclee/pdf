...
`extrafont` 폰트 팩키지 `font_import()` 함수를 사용해서 운영체제에 있는 글꼴을 R에서 사용할 수 있도록 설치할 수 있다.
...
sysfonts::font_add(family = "Noto Sans CJK", 
         regular = "NotoSansCJKkr-Regular.otf")
showtext_auto(enable = TRUE)

tmp_str <- sysfonts::font_paths()

tmp_str[str_detect(tmp_str, pattern = "nanum")]
